...
*** Keywords ***
Connect Instruments
    AFG2225Library.Open Connection    ${AFG2225_ADDR}    visa_library=pyvisa_sim.yaml@sim
    HP3458ALibrary.Open Connection    ${HP3458_ADDR}    visa_library=pyvisa_sim.yaml@sim
    HP53131ALibrary.Open Connection    ${HP53131_ADDR}    visa_library=pyvisa_sim.yaml@sim
